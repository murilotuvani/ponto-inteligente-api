...
import br.com.autogeral.pontointeligente.api.dtos.CadastroPJDto;
...
import br.com.autogeral.pontointeligente.api.entities.Perfil;
import br.com.autogeral.pontointeligente.api.response.Response;
...
import br.com.autogeral.pontointeligente.api.utils.PasswordUtils;
...
public class CadastroPJController {
	...
	@GetMapping
	public ResponseEntity<List<CadastroPJDto>> list() {
		List<Empresa> list = empresaService.list();
		List<CadastroPJDto> cadastros = new ArrayList<CadastroPJDto>();
		list.forEach(e-> cadastros.add(converterCadastroPJDto(e)));
	...
	/**
	 * Popula o DTO de cadastro com os dados da empresa.
	 * 
	 * @param empresa
	 * @return CadastroPJDto
	 */
	private CadastroPJDto converterCadastroPJDto(Empresa empresa) {
		CadastroPJDto cadastroPJDto = new CadastroPJDto();
		cadastroPJDto.setId(empresa.getId());
