...
import br.com.autogeral.pontointeligente.api.dtos.FuncionarioDto;
...
public class FuncionarioController {
	...
	private FuncionarioDto converterFuncionarioDto(Funcionario funcionario) {
	    ...
	    optionalBd.ifPresent(valorHora -> funcionarioDto.setValorHora(Optional.of(valorHora.toString())));
		return funcionarioDto;
	}
